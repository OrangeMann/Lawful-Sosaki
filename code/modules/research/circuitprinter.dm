...
/obj/machinery/r_n_d/circuit_imprinter
	...
	proc/TotalMaterials()
		return g_amount + gold_amount + diamond_amount + uranium_amount + plasma_amount
	...
	attackby(var/obj/item/O as obj, var/mob/user as mob)
		...
		if (O.is_open_container())
			return 0
		if (!istype(O, /obj/item/stack/sheet/glass) && !istype(O, /obj/item/stack/sheet/mineral/gold) && !istype(O, /obj/item/stack/sheet/mineral/diamond) && !istype(O, /obj/item/stack/sheet/mineral/uranium) && !istype(O, /obj/item/stack/sheet/mineral/plasma))
